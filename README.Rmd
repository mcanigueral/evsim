...
* Including the EV model inputs in a Shiny Dashboard (a Shiny module is provided)
...
Since the package is not yet in CRAN, you can install the development version of [evsim](https://github.com/mcanigueral/evsim/) from GitHub:
